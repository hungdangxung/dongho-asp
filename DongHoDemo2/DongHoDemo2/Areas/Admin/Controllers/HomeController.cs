    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var listDayOrdereds = _context.Orders
                .AsNoTracking()
                .Where(x => x.TransactStatusId == 4 && x.ShipDate.Value.Date == DateTime.Now.Date)
                .ToList();
            var listMonthOrdereds = _context.Orders
                .AsNoTracking()
                .Where(x => x.TransactStatusId == 4 && x.ShipDate.Value.Month == DateTime.Now.Month)
                .ToList();
            var list3MonthOrdereds = _context.Orders
                .AsNoTracking()
                .Where(x => x.TransactStatusId == 4 && ((x.ShipDate.Value.Month - 1)/3)== DateTime.Now.Month)
                .ToList();
            var listYearOrdereds = _context.Orders
                .AsNoTracking()
                .Where(x => x.TransactStatusId == 4 && x.ShipDate.Value.Year == DateTime.Now.Year)
                .ToList();
